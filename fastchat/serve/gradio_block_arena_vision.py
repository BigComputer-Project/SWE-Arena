...
- **Temperature**: All models have the same temperature of `0.2` and `top_p` of `1.0` by default. You can adjust the hyperparameters in the `Parameters` section. Low temperature typically works better for code generation.
